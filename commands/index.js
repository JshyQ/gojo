...
import { searchRule34 } from './rule34Commands.js';
...
// Pinterest SEARCH (API siputzx) — beda dari .pin yang download dari URL
reg(['pins', 'pinsearch', 'caripinterest', 'pinterestsearch'], async (ctx) =>
    socialDownloadCommands.searchPinterest(ctx));
// Rule34.xxx search (kredensial di setting.js → rule34)
reg(['r34', 'rule34', 'rule34xxx'], async (ctx) => searchRule34(ctx));
