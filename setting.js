...
export const settings = {
    ...
    // ── Rule34.xxx API (command .r34 / .rule34) ──────────────────────
    // Daftar di https://rule34.xxx → Account → Options → API
    // Bisa juga diisi lewat ENV: RULE34_API_KEY & RULE34_USER_ID
    rule34: {
        // API key dari dashboard Rule34 (Account → Options → API Access Credentials)
        // Bisa override lewat ENV: RULE34_API_KEY / RULE34_USER_ID
        apiKey: process.env.RULE34_API_KEY || 'ba2e0c25107feba680c6e48099f07c755787c4d0c46fdc7a12d6dc1d90c922bacabebcc1874c12103cb1cdbcd3ee317d0b635ecdad321375b4ad107fc3888aba',
        userId: process.env.RULE34_USER_ID || '5713982',
    },
